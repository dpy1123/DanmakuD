...
public class ImageUtils {
     ...
     * @throws IOException
     */
    public final static HashMap<String, Object> getInfo(InputStream file) throws IOException{
     ...
     * @throws IOException 
     */
    public final static byte[] scale(InputStream file, int height, int width, boolean bb) throws IOException {
     ...
     * @throws IOException 
     */
    public final static byte[] cut(InputStream file, int x, int y, int width, int height) throws IOException {
    	ByteArrayOutputStream result = new ByteArrayOutputStream();
		// 读取源图像
		BufferedImage bi = ImageIO.read(file);
