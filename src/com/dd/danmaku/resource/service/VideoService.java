...
public interface VideoService {
	 ...
	 * @return
	 */
	public Video getByFileName(String filename) throws Exception;
	
	/**
	 * 更新视频的时长
	 * @param duration 时长，秒
	 */
	public void updateVideoDuration(String id, long duration) throws Exception;
	 ...
	 */
	public void updatePreviewImg(String id, byte[] previewImg) throws Exception;
}
