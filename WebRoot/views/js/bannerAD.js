$(document).ready(function(){
	...
	//首页共有5个固定广告位，每个广告位有2块文字显示区域，请在下列参数修改广告文字
		...
		//广告位1  
		var imgAd01 = "views/images/bannerAD01.jpg";   //对应图片images/homeAd01.jpg
		var homeAd01 = "娱乐";   //第一块文字显示区域
		var myAd01 = "这里有丰富的娱乐视频<br/>还有各种生活记录";	 //第二块  可用<br/>换行
		
		//广告位2 
		var imgAd02 = "views/images/bannerAD02.jpg";
		var homeAd02 = "游戏";
		var myAd02 = "高手视频、游戏解说、风格点评<br/>样样俱全";
		
		//广告位3 
		var imgAd03 = "views/images/bannerAD03.jpg";
		var homeAd03 = "动漫视频";
		var myAd03 = "动漫相关的新番吐槽、同人、MAD等<br/>都在这里";
		
		//广告位4
		var imgAd04 = "views/images/bannerAD04.jpg";
		var homeAd04 = "音乐";
