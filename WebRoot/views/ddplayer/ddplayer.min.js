...
0.5;b.clazz=decodeURIComponent(b.clazz);b.param=decodeURIComponent(b.param);this.danmus.push(b)},tc2sec:function(a){a=a.split(":");return 3600*a[0]+60*a[1]+(a.length?parseFloat(a[2].replace(",",".")):0)},sec2tc:function(a){a=Math.floor(a);for(var b=0,c=0;0<a-60;)a-=60,b++;for(;0<b-60;)b-=60,c++;a=a.toString();1==a.length&&(a="0"+a);b=b.toString();1==b.length&&(b="0"+b);c=c.toString();1==c.length&&(c="0"+c);return c+":"+b+":"+a}};DD.Loader=function(a){this.statusDomElement=(this.showStatus=a)?DD.Loader.prototype.addStatusElement():null;this.onLoadStart=function(){};this.onLoadProgress=function(){};this.onLoadComplete=function(){}};
